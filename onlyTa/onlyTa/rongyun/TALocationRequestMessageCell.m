//
//  TALocationRequestMessageCell.m
//  OnlyTa
//
...
@implementation TALocationRequestMessageCell{
    CGSize textHeight;
}

+(CGSize)sizeForMessageModel:(RCMessageModel *)model withCollectionViewWidth:(CGFloat)collectionViewWidth referenceExtraHeight:(CGFloat)extraHeight{
    TALocationRequestMessage *message = (TALocationRequestMessage *)model.content;
...
-(void)setDataModel:(RCMessageModel *)model{
    ...
    TALocationRequestMessage *message=(TALocationRequestMessage*)self.model.content;
...
+(CGSize)getMessageContentSize:(TALocationRequestMessage *)message {
